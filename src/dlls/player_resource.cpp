...
//	SendPropArray( SendPropInt( SENDINFO_ARRAY(m_iPacketloss), 7, SPROP_UNSIGNED ), m_iPacketloss ),
	...
	//BG2 - Tjoppen - allocate more bits for damage(aka deaths)
	//+-8 million points of damage ought to be enough for anyone
	SendPropArray3( SENDINFO_ARRAY3(m_iDeaths), SendPropInt( SENDINFO_ARRAY(m_iDeaths), 24/*12*/ ) ),
	//
