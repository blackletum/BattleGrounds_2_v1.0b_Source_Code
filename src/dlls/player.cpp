...
void CBasePlayer::SetAnimation( PLAYER_ANIM playerAnim )
{
	...
	else if (idealActivity == ACT_WALK)
	{
		...
		if ((GetActivity() != ACT_RANGE_ATTACK1 && GetActivity() != ACT_RANGE_ATTACK2) || IsActivityFinished())
		{
			if ( GetFlags() & FL_DUCKING )	// crouching
			{
...
/*bool CBasePlayer::CheckSpawnPoints( void )
{
	//dummy function - always returns true for CBasePlayer
	return true;
}*/
