...
void CHL2MPClientScoreBoardDialog::AddHeader()
{
	...
	m_pPlayerList->AddColumnToSection(0, "deaths", "Damage", 0 | SectionedListPanel::COLUMN_RIGHT, scheme()->GetProportionalScaledValue( CSTRIKE_DEATH_WIDTH ) );
	//
